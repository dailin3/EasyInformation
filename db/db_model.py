...
class Assignments(BaseModel):
    ...
    assignment_id = TextField(column_name='assignmentId', null=True, unique=True)
    assignment_begin_time = TextField(column_name='crawlerTime', null=True)
    ...
    is_delete = IntegerField(column_name='isDelete',default=0, null=True)
    notice_times = IntegerField(column_name="annonceTimes",default=0, null=False)
